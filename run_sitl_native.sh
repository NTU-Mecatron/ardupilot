...
python3 Tools/autotest/sim_vehicle.py -v ArduCopter -f X --out udp:127.0.0.1:$OUT_PORT -L SGMarinaBarrage --add-param-file=params/sitl_json.parm -I $INSTANCE --sysid $SYSID