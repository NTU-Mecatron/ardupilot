...
const AP_Param::Info Plane::var_info[] = {
    ...
    // @Description: When enabled, this adds user stick input to the control surfaces in auto modes, allowing the user to have some degree of flight control without changing modes. Set to 1 to enable "fly by wire" mixing, which controls the pitch and yaw.
    ...
    // @Group: FINS_
    // @Path: fins_mixing.cpp
    GOBJECT(fins_mixing,      "FINS_",  FinsMixing),
