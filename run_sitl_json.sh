...
python3 Tools/autotest/sim_vehicle.py -v Rover --model JSON:${AP_JSON_IP:-127.0.0.1} --out udp:127.0.0.1:$OUT_PORT -L SGMarinaBarrage --add-param-file=params/sitl_json.parm -I $INSTANCE --sysid $SYSID